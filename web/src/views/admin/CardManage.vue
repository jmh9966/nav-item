      ...
      <table class="card-table">
        ...
        <tbody>
          <tr v-for="card in cards" :key="card.id">
            <td><input v-model="card.title"  class="table-input" /></td>
            <td><input v-model="card.url" class="table-input" /></td>
            <td><input v-model="card.logo_url"  class="table-input" placeholder="logo链接(可选)" /></td>
            <td><input v-model="card.desc" class="table-input" placeholder="描述（可选）" /></td>
            <td><input v-model.number="card.order" type="number" class="table-input order-input" /></td>
            <td>
                  <div class="btn-group">
                    <button class="btn btn-danger btn-icon" @click="deleteCard(card.id)" title="删除" style="margin-right: 16px;">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path d="M3 6h18M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/>
                        <path d="M10 11v6M14 11v6"/>
                      </svg>
                    </button>
                    <button class="btn btn-success btn-icon" @click="updateCard(card)" title="确认">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
